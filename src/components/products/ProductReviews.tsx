            ...
            {summary.totalCount > 0 && (
                <JsonLd
                    data={{
                        ...
                        "@id": `${process.env.NEXT_PUBLIC_STORE_URL || "https://nozfragrances.com"}${basePath}/products/${slug}#product`,
                        "url": `${process.env.NEXT_PUBLIC_STORE_URL || "https://nozfragrances.com"}${basePath}/products/${slug}`,
                        "name": productName,
                        "aggregateRating": {
